...
- Name: student-teacher-enrolled\quizzes.spec.ts >> UC-TE-03: View Quiz Results >> self_enrolled cannot access /student/results
- Location: playwright\student-teacher-enrolled\quizzes.spec.ts:106:7
...
Expected pattern: /\/student\/quizzes/
Received string:  "http://localhost:8080/login/student"
Timeout: 8000ms

Call log:
  - Expect "toHaveURL" with timeout 8000ms
    19 × unexpected value "http://localhost:8080/login/student"
