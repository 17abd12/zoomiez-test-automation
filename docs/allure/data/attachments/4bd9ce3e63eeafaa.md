...
- Name: institution\reports.spec.ts >> UC-IN-04: Institution Reports >> preview renders KPIs and topic breakdown
- Location: playwright\institution\reports.spec.ts:65:7
...
```
Error: locator.call: Test timeout of 30000ms exceeded.
Call log:
  - waiting for getByRole('combobox', { name: /student/i })
...
```ts
  ...
  3   |  * SENSITIVE stubs: Resend (email), no real PDF generation
  4   |  */
  5   | 
