...
- Name: student-teacher-enrolled\quizzes.spec.ts >> UC-TE-04: Evaluation Report >> partial answer shows insight blocks
- Location: playwright\student-teacher-enrolled\quizzes.spec.ts:171:7
...
Locator: getByText(/Missed discharge potential/i)
Expected: visible
Timeout: 8000ms
...
Call log:
  ...
  - waiting for getByText(/Missed discharge potential/i)
