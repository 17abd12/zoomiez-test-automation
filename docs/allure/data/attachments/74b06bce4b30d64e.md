...
- Name: student-teacher-enrolled\quizzes.spec.ts >> UC-TE-03: View Quiz Results >> results page shows submission list
- Location: playwright\student-teacher-enrolled\quizzes.spec.ts:100:7
...
- main:
  ...
  - paragraph: Scheduled quizzes and teacher-evaluated papers.
  - heading "Scheduled Quiz Results" [level=2]
  - text: No quiz results yet.
  - heading "Teacher Evaluations" [level=2]
  - text: No teacher evaluations yet.
```
